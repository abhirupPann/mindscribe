...
function Auth({type}: {type: "signin" | "signup"}) {
  ...
  <div className="flex h-screen lg:w-[50%] w-[100%] flex-col justify-center px-6 py-12 lg:px-8 bg-white dark:bg-gray-800">
    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      {type== "signup" ?<h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">Sign up to your account</h2>:
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      {type== "signin" ? 
        <Link to="/signup"><p className="mt-10 text-center text-sm text-gray-500 dark:text-gray-200">
        Not a member? <a href="#" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">SignUp</a></p></Link>
        :<Link to="/signin"><p className="mt-10 text-center text-sm text-gray-500 dark:text-gray-200">

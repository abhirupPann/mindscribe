...
function BlogCard( values: BlogCardVal) {
  return (
    <Link to={`${values.id}`}>
    <div className="flex mx-[1vw] my-[2vh] border dark:border-gray-700 shadow-md px-[2vw] py-[5vh] rounded-md">
      <div className=" flex flex-col gap-6 w-[100%] md:w-[75%]">
        <div className="head flex gap-4 items-center">
            ...
            <div className=" w-1 h-1 mt-[0.7vh] rounded-full bg-gray-400"></div>
            <p className="text-gray-400 dark:text-gray-300 rounded-full">{values.date}</p>
        </div>
        <div className="title text-2xl text-black dark:text-white font-bold">
            {values.title}
        </div>
        <div className="content text-gray-700 dark:text-gray-400 font-semibold">
